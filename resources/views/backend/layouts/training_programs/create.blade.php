        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-start gap-3 mb-8">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Add new training programs.</p>
                </div>
            </div>
            <!--end::Info-->
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        <h1 class="mb-4">Add Training Program</h1>
                        <form action="{{ route('admin.training_programs.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="file" class="dropify form-control @error('thumbnail') is-invalid @enderror"
                                    name="thumbnail" id="thumbnail" value="{{ old('thumbnail') }}" placeholder="Enter File" accept="image/*" data-default-file="{{ asset('backend/images/placeholder/image_placeholder.png') }}" />
                                @error('thumbnail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.training_programs.index') }}" class="btn btn-danger btn-lg">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
